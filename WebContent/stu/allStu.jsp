...
<script type="text/javascript" src="../js/stu/allStu.js">
</script>
<script type="text/javascript">
function formattercaozuo(value, row, index) {
	return "<a href='javascript:void(0)' onclick='Netfollow("
	+ index + ")'>跟踪</a> <a href='javascript:void(0)' onclick='edit(" + index
			+ ")'>编辑</a>   <a href='javascript:void(0)' onclick='chakan("
			+ index + ")'>查看</a> ";
}

var gz;
function Netfollow(index) {
	gz = index;
		...
		<table>
			...
			<tr>
				<td colspan="2" style="text-align: center;"><textarea rows="3"
						cols="25" readonly="readonly" id="gzcontent"></textarea></td>
			</tr>
		</table>
		...
		<form>
			<table>
					<tr>
						...
						<td><input class="easyui-validatebox" data-options="required:true" type="text"
							id="addname" /></td>
					</tr>

					<tr>
						<td><label for="name">性别:</label></td>
						<td><select id="addsex" class="easyui-combobox" data-options="required:true">
								<option value="">---请选择---</option>
					...
					<tr>
						...
						<td><input class="easyui-validatebox" type="text" id="addage" data-options="required:true" />
						</td>
					</tr>
			...
			<table>
				<thead>
					...
					<tr>
						...
						<td><input readonly="readonly"v class="easyui-validatebox" type="text" name="name" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td><label for="name">性别:</label></td>
						<td><select disabled="disabled" name="sex" class="easyui-combobox">
								<option value="">---请选择---</option>
								<option value="1">男</option>
								<option value="2">女</option>
						</select>
					...
					<tr>
						...
						<td><select disabled="disabled" id="state" name="state" class="easyui-combobox">   
								    <option value="">---请选择---</option>   
					...
					<tr>
						...
						<td><select disabled="disabled" name="isBaoBei" class="easyui-combobox">   
								    <option value="">---请选择---</option>   
					...
					<tr>
						...
						<td>
							<select disabled="disabled" name="isValid" class="easyui-combobox">   
								    <option value="">---请选择---</option>   
								    <option value="1">有效</option>   
								    <option value="2">无效</option>   
								</select>
